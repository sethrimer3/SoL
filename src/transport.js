...
class CommandQueue {
    ...
    consumeTickCommands(tick) {
        ...
        if (commands.length > 1) {
            commands.sort((a, b) => {
                var _a, _b;
                const aIndex = (_a = this.playerIdCache.get(a.playerId)) !== null && _a !== void 0 ? _a : this.UNKNOWN_PLAYER_INDEX;
                const bIndex = (_b = this.playerIdCache.get(b.playerId)) !== null && _b !== void 0 ? _b : this.UNKNOWN_PLAYER_INDEX;
