...
exports.ChronoFreezeCircle = exports.Chrono = exports.ShadowDecoyParticle = exports.ShadowDecoy = exports.Shadow = exports.BlinkShockwave = exports.Blink = exports.DashSlash = exports.Dash = exports.AurumShieldHit = exports.AurumOrb = exports.AurumHero = exports.VelarisOrb = exports.VelarisHero = exports.RadiantOrb = exports.Radiant = exports.DisintegrationParticle = exports.StickyLaser = exports.StickyBomb = exports.Sly = exports.NovaScatterBullet = exports.NovaBomb = exports.Nova = exports.CrescentWave = exports.Tank = exports.Spotlight = exports.HealingBombParticle = exports.Preist = exports.MortarProjectile = exports.Mortar = exports.Beam = exports.Dagger = exports.Driller = exports.DeployedTurret = exports.TurretDeployer = exports.InfluenceBallProjectile = exports.InfluenceZone = exports.InfluenceBall = exports.RayBeamSegment = exports.Ray = exports.GraveBlackHole = exports.GraveSmallParticle = exports.GraveProjectile = exports.Grave = exports.MiniMothership = exports.Mothership = exports.Marine = void 0;
...
const mothership_1 = require("./heroes/mothership");
...
const radiant_1 = require("./heroes/radiant");
const velaris_hero_1 = require("./heroes/velaris-hero");
const aurum_hero_1 = require("./heroes/aurum-hero");
const dash_1 = require("./heroes/dash");
const blink_1 = require("./heroes/blink");
const shadow_1 = require("./heroes/shadow");
const chrono_1 = require("./heroes/chrono");
...
const { Mothership, MiniMothership } = (0, mothership_1.createMothershipHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants,
    MuzzleFlash: particles_1.MuzzleFlash,
...
exports.MiniMothership = MiniMothership;
...
const { Radiant, RadiantOrb } = (0, radiant_1.createRadiantHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.Radiant = Radiant;
exports.RadiantOrb = RadiantOrb;
const { VelarisHero, VelarisOrb } = (0, velaris_hero_1.createVelarisHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.VelarisHero = VelarisHero;
exports.VelarisOrb = VelarisOrb;
const { AurumHero, AurumOrb, AurumShieldHit } = (0, aurum_hero_1.createAurumHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.AurumHero = AurumHero;
exports.AurumOrb = AurumOrb;
exports.AurumShieldHit = AurumShieldHit;
const { Dash, DashSlash } = (0, dash_1.createDashHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.Dash = Dash;
exports.DashSlash = DashSlash;
const { Blink, BlinkShockwave } = (0, blink_1.createBlinkHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.Blink = Blink;
exports.BlinkShockwave = BlinkShockwave;
const { Shadow, ShadowDecoy, ShadowDecoyParticle } = (0, shadow_1.createShadowHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.Shadow = Shadow;
exports.ShadowDecoy = ShadowDecoy;
exports.ShadowDecoyParticle = ShadowDecoyParticle;
const { Chrono, ChronoFreezeCircle } = (0, chrono_1.createChronoHero)({
    Unit: unit_1.Unit,
    Vector2D: math_1.Vector2D,
    Constants
});
exports.Chrono = Chrono;
exports.ChronoFreezeCircle = ChronoFreezeCircle;
