...
export const DUST_PUSH_MIN_SPEED_PX_PER_SEC = 4;
export const MIRROR_DUST_PUSH_RADIUS_PX = 80;
export const MIRROR_DUST_PUSH_FORCE_MULTIPLIER = 0.6;
export const FORGE_DUST_PUSH_RADIUS_PX = 120;
export const FORGE_DUST_PUSH_FORCE_MULTIPLIER = 0.5;
