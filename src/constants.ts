...
export const ASTEROID_ROTATION_KNOCKBACK_VELOCITY = 80; // Initial velocity when knocked by rotating asteroid (pixels/sec)
export const ASTEROID_ROTATION_KNOCKBACK_DECELERATION = 200; // Deceleration rate for knockback (pixels/sec²)
