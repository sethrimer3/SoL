/**
 * 1v1 Ranked Matchmaking Screen Renderer
 * Displays matchmaking interface for ranked 1v1 games
 */

export interface Matchmaking1v1ScreenParams {
...
export function renderMatchmaking1v1Screen(
    container: HTMLElement,
    params: Matchmaking1v1ScreenParams
): void {
    const { 
        onStartMatchmaking, 
        onCancelMatchmaking,
    ...
    title.textContent = '1v1 Ranked Matchmaking';
    ...
    statsTitle.textContent = '1v1 Ranked Stats';
    ...
    infoText.innerHTML = `
        <strong style="color: #FFD700;">1v1 Ranked Matchmaking:</strong><br>
        • Face off against a single opponent<br>
        • Win or lose MMR based on match outcome<br>
        • Separate MMR from 2v2 ranked games<br>
        • Fair matching based on your rating
    `;
