...
exports.DUST_SHADOW_FAR_MAX_DISTANCE_PX = 900;
exports.DUST_SHADOW_FAR_MIN_INTENSITY = 0.08;
exports.DUST_SHADOW_LENGTH_PX = 18;
exports.DUST_SHADOW_OPACITY = 0.14;
exports.DUST_SHADOW_WIDTH_PX = 0.45;
...
exports.DEATH_PARTICLE_SIZE_SCALE = 0.33;
exports.DEATH_PARTICLE_DUST_PUSH_RADIUS_PX = 42;
exports.DEATH_PARTICLE_DUST_PUSH_FORCE_MULTIPLIER = 0.42;
exports.DEATH_PARTICLE_BOUNCE_RESTITUTION = 0.52;
exports.DEATH_PARTICLE_BOUNCE_TANGENTIAL_DAMPING = 0.92;
...
exports.STAR_LAYER_CONFIGS = [
    { count: 1800, parallaxFactor: 0.08, sizeRange: [0.5, 1.4], brightnessScale: 0.7, blurVariance: 0.75 },
    { count: 1350, parallaxFactor: 0.15, sizeRange: [0.55, 1.8], brightnessScale: 0.85, blurVariance: 0.6 },
    { count: 950, parallaxFactor: 0.25, sizeRange: [0.7, 2.2], brightnessScale: 1.0, blurVariance: 0.45 },
    { count: 600, parallaxFactor: 0.38, sizeRange: [0.9, 2.8], brightnessScale: 1.15, blurVariance: 0.3 },
    { count: 300, parallaxFactor: 0.55, sizeRange: [1.1, 3.4], brightnessScale: 1.35, blurVariance: 0.18 }
];
...
exports.MIRROR_MAX_HEALTH = 200;
exports.MIRROR_DAMAGE_REDUCTION = 0.1; // 10% damage reduction from armor
...
exports.UNIT_LINE_OF_SIGHT_MULTIPLIER = 1.2; // Line of sight is 20% more than attack range
exports.SHADE_BRIGHTNESS_BOOST = 0.4; // Brightness boost in shaded areas near units (0-1)
exports.SHADE_BRIGHTNESS_RADIUS = 200; // Radius around units where brightness boost is applied
...
exports.FORGE_CRUNCH_INTERVAL = 20.0; // Seconds between crunches
exports.FORGE_CRUNCH_ENERGY_PER_SEC_PER_STARLING = 50; // Incoming light per second needed for 1 starling per crunch
...
exports.HERO_UNIT_BASE_COST = 3000;
exports.HERO_UNIT_COST_INCREMENT = 2000;
exports.SOLAR_MIRROR_COST = 50; // Cost to build additional solar mirrors
exports.STELLAR_FORGE_SOLAR_MIRROR_COST = 2000; // Cost to produce a solar mirror from the main stellar forge
...
exports.AI_MIRROR_AGGRESSIVE_DISTANCE_PX = 180; // Very close to sun for max energy
exports.AI_MIRROR_DEFENSIVE_DISTANCE_PX = 400; // Further from sun, closer to base
exports.AI_MIRROR_ECONOMIC_DISTANCE_PX = 250; // Balanced distance
exports.AI_MIRROR_WAVES_DISTANCE_PX = 280; // Moderate distance
exports.AI_MIRROR_PLACEMENT_ATTEMPTS = 8; // Number of attempts to find valid mirror position
exports.AI_MIRROR_GUARD_DISTANCE_PX = 80; // Distance from mirror to place guards
exports.AI_MIRROR_COLLISION_RADIUS_PX = 20; // Mirror collision detection radius
exports.AI_MIRROR_RADIUS_VARIATION_STEP_PX = 30; // Step size for radius variation when finding positions
exports.AI_MIRROR_RADIUS_VARIATION_OFFSET_PX = 60; // Offset for radius variation (varies from -60 to +60)
exports.AI_MIRROR_ANGLE_VARIATION_STEP_RAD = 0.15; // Step size for angle variation when finding positions
exports.AI_MIRROR_ANGLE_VARIATION_OFFSET_RAD = 0.6; // Offset for angle variation (varies from -0.6 to +0.6)
...
exports.ASTEROID_ROTATION_KNOCKBACK_VELOCITY = 80; // Initial velocity when knocked by rotating asteroid (pixels/sec)
exports.ASTEROID_ROTATION_KNOCKBACK_DECELERATION = 200; // Deceleration rate for knockback (pixels/sec²)
...
exports.CLICK_DRAG_THRESHOLD = 16; // Pixels of movement to distinguish click from drag (more forgiving so quick taps are not treated as drags)
