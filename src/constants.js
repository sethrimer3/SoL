...
exports.DUST_ASTEROID_COLLISION_PADDING_PX = 1.5;
exports.DUST_ASTEROID_BOUNCE_RESTITUTION = 0.72;
exports.DUST_ASTEROID_TANGENTIAL_PUSH_MULTIPLIER = 0.28;
exports.DUST_ASTEROID_ROTATION_COLLISION_PUSH_MULTIPLIER = 0.5;
...
exports.MOTHERSHIP_MAX_HEALTH = 100;
exports.MOTHERSHIP_ATTACK_RANGE = 300;
exports.MOTHERSHIP_ATTACK_DAMAGE = 10;
exports.MOTHERSHIP_ATTACK_SPEED = 2.5; // Attacks per second (half as fast as Marine)
...
exports.FORGE_CRUNCH_ENERGY_PER_SEC_PER_STARLING = 20; // Incoming light per second needed for 1 starling per crunch
...
exports.HERO_UNIT_BASE_COST = 300;
exports.HERO_UNIT_COST_INCREMENT = 200;
exports.SOLAR_MIRROR_COST = 50; // Cost to build additional solar mirrors
exports.STELLAR_FORGE_SOLAR_MIRROR_COST = 500; // Required incoming sunlight/sec to produce a solar mirror from the main stellar forge
...
exports.ASTEROID_KNOCKBACK_INITIAL_VELOCITY = 80; // Initial knockback velocity in pixels per second
exports.ASTEROID_KNOCKBACK_DECELERATION = 200; // Knockback deceleration in pixels per second squared
exports.SOLAR_MIRROR_COLLISION_RADIUS = 20; // Approximate collision radius for solar mirrors in pixels
...
exports.MOTHERSHIP_ABILITY_COOLDOWN = 8.0; // 8 seconds
exports.MOTHERSHIP_MINI_COUNT = 3; // Number of mini-motherships spawned
exports.MOTHERSHIP_MINI_FORMATION_RADIUS = 50; // Distance from mothership in triangle formation
exports.MOTHERSHIP_MINI_SPEED = 150; // Movement speed (pixels per second)
exports.MOTHERSHIP_MINI_LIFETIME = 12.0; // Maximum lifetime before auto-explosion (seconds)
exports.MOTHERSHIP_MINI_HEALTH = 50; // Health (same as starlings)
exports.MOTHERSHIP_MINI_ATTACK_RANGE = 120; // Attack range (same as starlings)
exports.MOTHERSHIP_MINI_ATTACK_DAMAGE = 5; // Damage per shot (same as starlings)
exports.MOTHERSHIP_MINI_ATTACK_SPEED = 2; // Attacks per second (same as starlings)
exports.MOTHERSHIP_MINI_COLLISION_RADIUS = 8; // Collision radius for environment/structures
exports.MOTHERSHIP_MINI_EXPLOSION_RADIUS = 80; // Splash damage radius
exports.MOTHERSHIP_MINI_EXPLOSION_DAMAGE = 30; // Damage at explosion center
exports.MOTHERSHIP_MINI_EXPLOSION_FALLOFF = 0.3; // Minimum damage multiplier at edge (30%)
// UI constants
...
exports.RADIANT_MAX_HEALTH = 120;
exports.RADIANT_ABILITY_COOLDOWN = 4.0;
exports.RADIANT_ORB_SPEED_MULTIPLIER = 3.0; // Multiplier for arrow length to orb speed
exports.RADIANT_ORB_MAX_SPEED = 600;
exports.RADIANT_ORB_DECELERATION = 150; // px/s^2
exports.RADIANT_ORB_BOUNCE_DAMPING = 0.7; // Velocity multiplier on bounce
exports.RADIANT_ORB_MIN_RANGE = 100; // Minimum connection range when stopped
exports.RADIANT_ORB_MAX_RANGE = 400; // Maximum connection range at full speed
exports.RADIANT_MAX_ORBS = 3;
exports.RADIANT_LASER_DAMAGE_PER_SEC = 80; // Damage for crossing laser
exports.RADIANT_ORB_RADIUS = 15; // Visual radius of orb
// Velaris hero constants (orb-based light-blocking hero)
exports.VELARIS_HERO_MAX_HEALTH = 120;
exports.VELARIS_HERO_ABILITY_COOLDOWN = 4.0;
exports.VELARIS_ORB_SPEED_MULTIPLIER = 3.0;
exports.VELARIS_ORB_MAX_SPEED = 600;
exports.VELARIS_ORB_DECELERATION = 150;
exports.VELARIS_ORB_BOUNCE_DAMPING = 0.7;
exports.VELARIS_ORB_MIN_RANGE = 100;
exports.VELARIS_ORB_MAX_RANGE = 400;
exports.VELARIS_MAX_ORBS = 3;
exports.VELARIS_ORB_RADIUS = 15;
exports.VELARIS_PARTICLE_SPEED = 200; // Speed of particles between orbs
// Chrono hero constants
exports.CHRONO_MAX_HEALTH = 100;
exports.CHRONO_ATTACK_RANGE = 400;
exports.CHRONO_ATTACK_DAMAGE = 0; // Doesn't do damage, just freezes
exports.CHRONO_ATTACK_SPEED = 1.0; // 1 attack per second
exports.CHRONO_FREEZE_DURATION = 1.0; // Freeze duration in seconds
exports.CHRONO_ABILITY_BASE_COOLDOWN = 5.0; // Base cooldown for ability
exports.CHRONO_ABILITY_MIN_RADIUS = 50; // Minimum circle radius
exports.CHRONO_ABILITY_MAX_RADIUS = 300; // Maximum circle radius
exports.CHRONO_ABILITY_RADIUS_MULTIPLIER = 2.0; // Arrow length to radius conversion
exports.CHRONO_ABILITY_COOLDOWN_PER_RADIUS = 0.02; // Additional cooldown per unit of radius
exports.CHRONO_FREEZE_CIRCLE_DURATION = 3.0; // How long the freeze circle lasts
// Aurum hero constants (orb-based shield field hero)
exports.AURUM_HERO_MAX_HEALTH = 120;
exports.AURUM_HERO_ABILITY_COOLDOWN = 5.0;
exports.AURUM_ORB_SPEED_MULTIPLIER = 3.0;
exports.AURUM_ORB_MAX_SPEED = 600;
exports.AURUM_ORB_DECELERATION = 150;
exports.AURUM_ORB_BOUNCE_DAMPING = 0.7;
exports.AURUM_ORB_MIN_RANGE = 100;
exports.AURUM_ORB_MAX_RANGE = 400;
exports.AURUM_MAX_ORBS = 4;
exports.AURUM_ORB_MAX_HEALTH = 200; // Orbs can take damage
exports.AURUM_ORB_RADIUS = 15;
exports.AURUM_SHIELD_OFFSET = 25; // Distance from orb center where shield starts
exports.AURUM_SHIELD_HIT_DURATION = 0.3; // Duration of hit flash effect
// Dash hero constants (Aurum faction - rapid dash attack)
exports.DASH_MAX_HEALTH = 110;
exports.DASH_ABILITY_COOLDOWN = 3.0; // Quick cooldown
exports.DASH_SPEED = 800; // Very fast dash speed (pixels per second)
exports.DASH_DISTANCE_MULTIPLIER = 1.5; // Multiplier for arrow length to dash distance
exports.DASH_MIN_DISTANCE = 100; // Minimum dash distance
exports.DASH_MAX_DISTANCE = 500; // Maximum dash distance
exports.DASH_SLASH_RADIUS = 30; // Radius around dash position that damages units
exports.DASH_SLASH_DAMAGE = 40; // Damage dealt to units hit by dash
// Blink hero constants (Aurum faction - teleport with shockwave)
exports.BLINK_MAX_HEALTH = 100;
exports.BLINK_ABILITY_COOLDOWN = 6.0; // Moderate cooldown
exports.BLINK_DISTANCE_MULTIPLIER = 1.5; // Multiplier for arrow length to blink distance
exports.BLINK_MIN_DISTANCE = 80; // Minimum blink distance
exports.BLINK_MAX_DISTANCE = 400; // Maximum blink distance
exports.BLINK_SHOCKWAVE_MIN_RADIUS = 60; // Minimum shockwave radius (at max blink distance)
exports.BLINK_SHOCKWAVE_MAX_RADIUS = 180; // Maximum shockwave radius (at min blink distance)
exports.BLINK_SHOCKWAVE_DAMAGE = 20; // Damage dealt by shockwave
exports.BLINK_STUN_DURATION = 1.0; // Stun duration in seconds
exports.BLINK_SHOCKWAVE_VISUAL_DURATION = 0.4; // Duration of visual effect in seconds
exports.BLINK_SHOCKWAVE_HIT_WINDOW = 0.05; // Time window for shockwave hit detection in seconds
// Shadow hero constants (Velaris faction - beam attack with decoy)
exports.SHADOW_MAX_HEALTH = 100;
exports.SHADOW_ATTACK_RANGE = 200;
exports.SHADOW_ATTACK_DAMAGE = 15; // Base damage per attack
exports.SHADOW_ATTACK_SPEED = 10.0; // Very fast attack speed for "constant beam" effect
exports.SHADOW_ABILITY_COOLDOWN = 8.0; // 8 second cooldown for decoy
exports.SHADOW_COLLISION_RADIUS_PX = 15;
exports.SHADOW_BEAM_MULTIPLIER_PER_SECOND = 0.8; // Increases by 0.8 per second (reaches 5x in 5 seconds)
exports.SHADOW_BEAM_MAX_MULTIPLIER = 5.0; // Maximum 5x damage multiplier
exports.SHADOW_DECOY_HEALTH_MULTIPLIER = 3.0; // Decoy has 3x hero health
exports.SHADOW_DECOY_SPEED_MULTIPLIER = 2.5; // Multiplier for arrow length to speed
exports.SHADOW_DECOY_MAX_SPEED = 400; // Maximum decoy speed
exports.SHADOW_DECOY_COLLISION_RADIUS = 15; // Collision radius for decoy
exports.SHADOW_DECOY_HIT_OPACITY = 0.75; // Opacity when hit
exports.SHADOW_DECOY_FADE_SPEED = 1.0; // Fade speed per second (75% -> 100% in 0.25 seconds)
exports.SHADOW_DECOY_PARTICLE_COUNT = 30; // Number of particles on despawn
exports.SHADOW_DECOY_PARTICLE_SPEED = 200; // Speed of despawn particles
exports.SHADOW_DECOY_PARTICLE_LIFETIME = 1.5; // Lifetime of particles in seconds
exports.SHADOW_DECOY_PARTICLE_SIZE = 3; // Size of particles
// AI Strategy types
var AIStrategy;
(function (AIStrategy) {
