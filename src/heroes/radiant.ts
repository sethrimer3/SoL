...
export const createRadiantHero = (deps: RadiantHeroDeps) => {
    ...
    class RadiantOrb {
        lifetime: number = 0;
        deceleration: number = Constants.RADIANT_ORB_DECELERATION;
    ...
    class Radiant extends Unit {
        private orbToCreate: RadiantOrb | null = null;

        constructor(position: Vector2D, owner: Player) {
            super(
                position,
                owner,
                Constants.RADIANT_MAX_HEALTH,
        ...
        useAbility(direction: Vector2D): boolean {
            ...
            this.orbToCreate = new RadiantOrb(
         ...
         */
        getAndClearOrb(): RadiantOrb | null {
