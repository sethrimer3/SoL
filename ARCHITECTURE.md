...
The command list above was revalidated after hashing manual unit target state and adding structure-target order synchronization to ensure `stateHash` stability.
