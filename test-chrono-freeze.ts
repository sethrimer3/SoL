 ...
 */
import { GameState, Player, Vector2D, Faction, Chrono, Starling } from './src/game-core';
...
const player1 = new Player('Player-1', Faction.VELARIS);
const player2 = new Player('Player-2', Faction.RADIANT);
player1.energy = 5000;
player2.energy = 5000;

game.players.push(player1, player2);
game.initializePlayer(player1, new Vector2D(-300, 0), []);
game.initializePlayer(player2, new Vector2D(300, 0), []);

// Create Chrono hero for player 1
console.log('2. Creating Chrono hero...');
const chrono = new Chrono(new Vector2D(-200, 0), player1);
player1.units.push(chrono);

// Create enemy unit for player 2
const enemyUnit = new Starling(new Vector2D(100, 0), player2);
...
const abilityDirection = new Vector2D(100, 0); // Draw arrow to the right
...
const smallArrow = new Vector2D(10, 0);
const largeArrow = new Vector2D(200, 0);
...
const chrono2 = new Chrono(new Vector2D(-200, 100), player1);
